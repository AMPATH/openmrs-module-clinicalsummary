 ...
 *
 */
public abstract class BaseLatestSingleResultRule implements Rule {
	
	private static final Log log = LogFactory.getLog(BaseLatestSingleResultRule.class);
	...
	public Result eval(LogicContext context, Patient patient, Map<String, Object> parameters) throws LogicException {
		...
		LogicCriteria encounterCriteria = service.parseToken(SummaryDataSource.ENCOUNTER_TYPE).in(
		    Arrays.asList(TypeConstants.ANC_INITIAL, TypeConstants.ANC_RETURN)).last();
