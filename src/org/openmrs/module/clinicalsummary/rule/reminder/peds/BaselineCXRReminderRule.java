 ...
 * 
 */
public class BaselineCXRReminderRule implements Rule {
	
	private static final Log log = LogFactory.getLog(BaselineCXRReminderRule.class);
	
	private static final String CRX_REMINDER = "Please check Chest X-Ray. Positive PCR or ELISA but no X-Ray result";
