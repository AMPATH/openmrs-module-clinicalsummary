 ...
 * 
 */
public class BaselineSGPTReminderRule implements Rule {
	
	private static final Log log = LogFactory.getLog(BaselineCXRReminderRule.class);
	
	private static final String SGPT_REMINDER = "Please check SGPT. Positive PCR or ELISA but no SGPT result";
