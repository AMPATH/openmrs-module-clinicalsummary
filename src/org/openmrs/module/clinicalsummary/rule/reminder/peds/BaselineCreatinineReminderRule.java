 ...
 * 
 */
public class BaselineCreatinineReminderRule implements Rule {
	
	private static final Log log = LogFactory.getLog(BaselineCXRReminderRule.class);
	
	private static final String CREATININE_REMINDER = "Please check Creatinine. Positive PCR or ELISA but no Creatinine result";
