 ...
 * 
 */
public class BaselineHGBReminderRule implements Rule {
	
	private static final Log log = LogFactory.getLog(BaselineCXRReminderRule.class);
	
	private static final String HEMOGLOBIN_REMINDER = "Please check Hemoglobin. Positive PCR or ELISA but no Hemoglobin result";
