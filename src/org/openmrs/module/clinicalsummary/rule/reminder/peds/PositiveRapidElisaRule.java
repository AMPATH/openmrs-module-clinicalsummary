 ...
 *
 */
public class PositiveRapidElisaRule implements Rule {
	
	private static final Log log = LogFactory.getLog(PositiveRapidElisaRule.class);
	...
	public Result eval(LogicContext context, Patient patient, Map<String, Object> parameters) throws LogicException {
		...
		if (birthdate != null) {
			...
			LogicCriteria conceptCriteria = service.parseToken(SummaryDataSource.CONCEPT).equalTo(StandardConceptConstants.RAPID_ELISA_NAME);
