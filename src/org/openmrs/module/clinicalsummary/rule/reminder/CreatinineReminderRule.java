 ...
 * 
 */
public class CreatinineReminderRule implements Rule {
	
	private static final Log log = LogFactory.getLog(CXRReminderRule.class);
	
	private static final String CREATININE_REMINDER = "Please check Creatinine. No Creatinine result in system";
