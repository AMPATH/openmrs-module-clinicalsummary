...
public class EncounterTypeEditor extends PropertyEditorSupport {
	...
	private static final Log log = LogFactory.getLog(EncounterTypeEditor.class);
	...
	public String getAsText() {
		EncounterType encounterType = (EncounterType) getValue();
		if (encounterType != null)
			return String.valueOf(encounterType.getEncounterTypeId());
	...
	public void setAsText(final String text) throws IllegalArgumentException {
		if (StringUtils.isNotEmpty(text)) {
			EncounterType encounterType = Context.getEncounterService().getEncounterType(NumberUtils.toInt(text, -1));
