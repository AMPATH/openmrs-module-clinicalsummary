 ...
 */
public class Element13BRule extends EvaluableRule {

    public static final String TOKEN = "Tuberculosis:Element 13B";
    ...
    protected Result evaluate(final LogicContext context, final Integer patientId, final Map<String, Object> parameters) {
        ...
        if (!encounterResults.isEmpty()) {
            ...
            parameters.put(EvaluableConstants.OBS_VALUE_CODED, Arrays.asList(MOST, ALL));
