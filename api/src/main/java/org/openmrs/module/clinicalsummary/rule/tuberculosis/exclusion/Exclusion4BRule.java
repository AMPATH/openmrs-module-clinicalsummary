 ...
 */
public class Exclusion4BRule extends EvaluableRule {

    public static final String TOKEN = "Tuberculosis:Exclusion 4B";
    ...
    protected Result evaluate(final LogicContext context, final Integer patientId, final Map<String, Object> parameters) {
        ...
        String TB_PROPHYLAXIS_START_DATE = "TB PROPHYLAXIS START DATE"; // 6984
