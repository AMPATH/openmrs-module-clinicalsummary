...
public class PediatricCreatinineReminderRule extends EvaluableRule {

	private static final Log log = LogFactory.getLog(PediatricCreatinineReminderRule.class);

	public static final String TOKEN = "Pediatric Creatinine Reminder";
