 ...
 */
public class TuberculosisRule extends EvaluableRule {

	private static final Log log = LogFactory.getLog(TuberculosisRule.class);

	public static final String TOKEN = "Tuberculosis Medications";
	...
	protected Result evaluate(final LogicContext context, final Integer patientId, final Map<String, Object> parameters) throws LogicException {
		...
		if (encounters != null) {
			...
			parameters.put(EvaluableConstants.OBS_VALUE_CODED, Arrays.asList(EvaluableNameConstants.START_DRUGS,
					EvaluableNameConstants.CONTINUE_REGIMEN));
			...
			parameters.put(EvaluableConstants.OBS_VALUE_CODED, Arrays.asList(EvaluableNameConstants.ISONIAZID,
					EvaluableNameConstants.RIFAMPICIN, EvaluableNameConstants.PYRAZINAMIDE));
