 ...
 */
public class PositiveNightSweatExistsRule extends EvaluableRule {

    public static final String TOKEN = "Tuberculosis:Positive Night Sweat Exists";
    ...
    protected Result evaluate(final LogicContext context, final Integer patientId, final Map<String, Object> parameters) {
        ...
        String NIGHT_SWEAT = "NIGHT SWEATS";

        parameters.put(EvaluableConstants.OBS_VALUE_CODED, Arrays.asList(NIGHT_SWEAT));
        ...
        String NIGHT_SWEATS_MORE_THAN_TWO_WEEKS = "NIGHT SWEATS MORE THAN TWO WEEKS";

        parameters.put(EvaluableConstants.OBS_VALUE_CODED, Arrays.asList(NIGHT_SWEATS_MORE_THAN_TWO_WEEKS));
