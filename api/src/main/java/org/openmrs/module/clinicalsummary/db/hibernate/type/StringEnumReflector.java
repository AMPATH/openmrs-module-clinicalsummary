 ...
 */
public class StringEnumReflector {
	
	private StringEnumReflector() {
	}
	 ...
	 */
	public static <T extends Enum<T> & StringEnum> String getNameFromValue(final Class<T> enumClass, final String value) {
