 ...
 */
public class PneumocystisCariniiRule extends EvaluableRule {

	private static final Log log = LogFactory.getLog(PneumocystisCariniiRule.class);

	public static final String TOKEN = "Pneumocystis Carinii Medications";
