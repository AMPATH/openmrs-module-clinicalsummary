 ...
 */
public class CxrResultExistsRule extends EvaluableRule {

    public static final String TOKEN = "Tuberculosis:CXR Result Exists";
    ...
    protected Result evaluate(final LogicContext context, final Integer patientId, final Map<String, Object> parameters) {
        ...
        Result cxrResult = obsWithRestrictionRule.eval(context, patientId, parameters);
        if (!cxrResult.isEmpty()) {
