 ...
 */
public class Exclusion2GRule extends EvaluableRule {

    public static final String TOKEN = "Tuberculosis:Exclusion 2G";
    ...
    protected Result evaluate(final LogicContext context, final Integer patientId, final Map<String, Object> parameters) {
        ...
        String REVIEW_OF_SYSTEMS_CARDIOPULMONARY = "REVIEW OF SYSTEMS, CARDIOPULMONARY"; // 1071
