 ...
 */
public class Exclusion4ARule extends EvaluableRule {

    public static final String TOKEN = "Tuberculosis:Exclusion 4A";
    ...
    protected Result evaluate(final LogicContext context, final Integer patientId, final Map<String, Object> parameters) {
        ...
        parameters.put(EvaluableConstants.OBS_CONCEPT, Arrays.asList(CURRENT_TB_PROPHYLAXIS));
