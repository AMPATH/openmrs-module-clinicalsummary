...
public class Over400CD4OnARVReminderRule extends EvaluableRule {

	private static final Log log = LogFactory.getLog(Over400CD4OnARVReminderRule.class);

	public static final String TOKEN = "Over 400 CD4 On Anti Retro Viral Reminder";
