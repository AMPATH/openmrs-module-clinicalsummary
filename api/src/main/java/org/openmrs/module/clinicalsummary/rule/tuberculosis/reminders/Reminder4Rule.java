...
import org.openmrs.module.clinicalsummary.rule.tuberculosis.element.Element4ARule;
import org.openmrs.module.clinicalsummary.rule.tuberculosis.element.Element4BRule;
 ...
 */
public class Reminder4Rule extends EvaluableRule {

    public static final String TOKEN = "Tuberculosis: Reminder 4";
...
//            result.add(new Result("Reminder 4 excluded by Ex1A"));
//            return result;
//        }
//
...
//            result.add(new Result("Reminder 4 excluded by Ex1B"));
//            return result;
//        }
//
        ...
        if (exclusion1CResult.toBoolean()) {
            result.add(new Result("Reminder 4 excluded by Ex1C"));
            return result;
        }
//
...
//            result.add(new Result("Reminder 4 excluded by Ex1D"));
//            return result;
//        }
        ...
        if (exclusion2AResult.toBoolean()) {
            result.add(new Result("Reminder 4 excluded by Ex2A"));
            return result;
        }
        ...
        if (exclusion2BResult.toBoolean()) {
            result.add(new Result("Reminder 4 excluded by Ex2B"));
            return result;
        }
        ...
        if (exclusion2CResult.toBoolean()) {
            result.add(new Result("Reminder 4 excluded by Ex2C"));
            return result;
        }
        ...
        if (exclusion2DResult.toBoolean()) {
            result.add(new Result("Reminder 4 excluded by Ex2D"));
            return result;
        }
        ...
        if (exclusion2FResult.toBoolean()) {
            result.add(new Result("Reminder 4 excluded by Ex2F"));
            return result;
        }
        ...
        if (exclusion2EResult.toBoolean()) {
            result.add(new Result("Reminder 4 excluded by Ex2E"));
            return result;
        }
        ...
        if (exclusion2GResult.toBoolean()) {
            result.add(new Result("Reminder 4 excluded by Ex2G"));
            return result;
        }
        ...
        if (exclusion3AResult.toBoolean()) {
            result.add(new Result("Reminder 4 excluded by Ex3A"));
            return result;
        }
        ...
        if (exclusion3BResult.toBoolean()) {
            result.add(new Result("Reminder 4 excluded by Ex3B"));
            return result;
        }
        ...
        if (exclusion3DResult.toBoolean()) {
            result.add(new Result("Reminder 4 excluded by Ex3D"));
            return result;
        }
        ...
        if (exclusion4AResult.toBoolean()) {
            result.add(new Result("Reminder 4 excluded by Ex4A"));
            return result;
        }
        ...
        if (exclusion4BResult.toBoolean()) {
            result.add(new Result("Reminder 4 excluded by Ex4B"));
            return result;
        }
        ...
        if (exclusion4CResult.toBoolean()) {
            result.add(new Result("Reminder 4 excluded by Ex4C"));
            return result;
        }
        ...
        if (exclusion4DResult.toBoolean()) {
            result.add(new Result("Reminder 4 excluded by Ex4D"));
            return result;
        }

        Element4ARule element4ARule = new Element4ARule();
        Result element4AResult = element4ARule.eval(context, patientId, new HashMap<String, Object>());
        if (element4AResult.toBoolean()) {
            result.add(new Result("Reminder 4 excluded by E4A"));
            return result;
        }

        Element4BRule element4BRule = new Element4BRule();
        Result element4BResult = element4BRule.eval(context, patientId, new HashMap<String, Object>());
        if (element4BResult.toBoolean()) {
            result.add(new Result("Reminder 4 excluded by E4B"));
            return result;
        }
