...
class EncounterTypeCacheInstance {

	private static final Log log = LogFactory.getLog(EncounterTypeCacheInstance.class);

	private static EncounterTypeCacheInstance ourInstance = new EncounterTypeCacheInstance();

	public static EncounterTypeCacheInstance getInstance() {
		return ourInstance;
	}

	private final Map<String, EncounterType> encounterTypeMap;

	private EncounterTypeCacheInstance() {
