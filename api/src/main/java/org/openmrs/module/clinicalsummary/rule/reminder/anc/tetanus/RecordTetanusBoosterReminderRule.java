...
public class RecordTetanusBoosterReminderRule extends AbstractTetanusBoosterReminderRule {

	private static final Log log = LogFactory.getLog(RecordTetanusBoosterReminderRule.class);

	private static final String TOKEN = AbstractTetanusBoosterReminderRule.RECORD_TETANUS_BOOSTER_REMINDER;
