...
public class SecondPreventiveTreatmentReminderRule extends EvaluableRule {

	private static final Log log = LogFactory.getLog(SecondPreventiveTreatmentReminderRule.class);

	public static final String TOKEN = "Second Intermittent Preventive Treatment Reminder";
	...
	protected Result evaluate(final LogicContext context, final Integer patientId, final Map<String, Object> parameters) throws LogicException {
		...
		if (CollectionUtils.isNotEmpty(pregnancyDateResults)) {
			...
			if (gestationalAge >= 28) {
				...
				parameters.put(EvaluableConstants.OBS_VALUE_CODED, Arrays.asList(EvaluableNameConstants.SECOND_INTERMITTENT_PREVENTIVE_TREATMENT));
