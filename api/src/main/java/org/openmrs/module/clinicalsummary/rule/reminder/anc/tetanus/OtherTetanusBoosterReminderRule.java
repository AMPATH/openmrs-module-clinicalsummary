...
public class OtherTetanusBoosterReminderRule extends AbstractTetanusBoosterReminderRule {

	private static final Log log = LogFactory.getLog(OtherTetanusBoosterReminderRule.class);

	private static final String TOKEN = AbstractTetanusBoosterReminderRule.OTHER_TETANUS_BOOSTER_REMINDER;
