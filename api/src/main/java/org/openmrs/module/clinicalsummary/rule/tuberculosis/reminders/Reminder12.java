...
import org.openmrs.module.clinicalsummary.rule.tuberculosis.element.Element12C;
 ...
 */
public class Reminder12 extends EvaluableRule {
    ...
    protected Result evaluate(final LogicContext context, final Integer patientId, final Map<String, Object> parameters) {
        ...
        Element12C element12C = new Element12C();
        Result element12CResult = element12C.eval(context, patientId, parameters);
