 ...
 */
public class PositiveFeverExistsRule extends EvaluableRule {

    public static final String TOKEN = "Tuberculosis:Positive Fever Exists";
    ...
    protected Result evaluate(final LogicContext context, final Integer patientId, final Map<String, Object> parameters) {
        ...
        parameters.put(EvaluableConstants.OBS_VALUE_CODED, Arrays.asList(FEVER));
        ...
        String FEVER_MORE_THAN_TWO_WEEKS = "FEVER MORE THAN TWO WEEKS";

        parameters.put(EvaluableConstants.OBS_VALUE_CODED, Arrays.asList(FEVER_MORE_THAN_TWO_WEEKS));
