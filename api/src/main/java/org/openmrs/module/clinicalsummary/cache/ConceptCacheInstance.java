 ...
 */
class ConceptCacheInstance {

	private static final Log log = LogFactory.getLog(ConceptCacheInstance.class);

	private static final ConceptCacheInstance ourInstance = new ConceptCacheInstance();

	/**
	 * @return
	 */
	public static ConceptCacheInstance getInstance() {
		return ourInstance;
	}
