 ...
 */
public class Exclusion3ARule extends EvaluableRule {

    public static final String TOKEN = "Tuberculosis:Exclusion 3A";
    ...
    protected Result evaluate(final LogicContext context, final Integer patientId, final Map<String, Object> parameters) {
        ...
        String XRAY_CHEST_PRELIMINARY_FINDINGS = "X-RAY, CHEST, PRELIMINARY FINDINGS"; // 12
        ...
        parameters.put(EvaluableConstants.OBS_VALUE_CODED, Arrays.asList(MILIARY_CHANGES, CAVITARY_LESION));
