...
class ResultCacheKey {
	...
	private static final Log log = LogFactory.getLog(ResultCacheKey.class);
	 ...
	 * @param parameters
	 */
	ResultCacheKey(final Integer patientId, final String token, final Map<String, Object> parameters) {
	...
	public boolean equals(final Object o) {
		...
		final ResultCacheKey that = (ResultCacheKey) o;
