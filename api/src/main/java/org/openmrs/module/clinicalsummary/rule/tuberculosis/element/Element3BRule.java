 ...
 */
public class Element3BRule extends EvaluableRule {

    public static final String TOKEN = "Tuberculosis:Element 3B";
    ...
    protected Result evaluate(final LogicContext context, final Integer patientId, final Map<String, Object> parameters) {
        ...
        if (!encounterResults.isEmpty()) {
            ...
            parameters.put(EvaluableConstants.OBS_VALUE_CODED,
                    Arrays.asList(EVIDENCE_OF_CARDIAC_ENLARGEMENT, NORMAL));
