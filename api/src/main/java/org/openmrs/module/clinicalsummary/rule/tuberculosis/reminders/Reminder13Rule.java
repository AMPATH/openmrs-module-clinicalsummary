 ...
 */
public class Reminder13Rule extends EvaluableRule {

    public static final String TOKEN = "Tuberculosis: Reminder 13";
...
//            result.add(new Result("Reminder 13 excluded by Ex1A"));
//            return result;
//        }
//
...
//            result.add(new Result("Reminder 13 excluded by Ex1B"));
//            return result;
//        }
//
...
//            result.add(new Result("Reminder 13 excluded by Ex1D"));
//            return result;
//        }
        ...
        Result element13BResult = element13BRule.eval(context, patientId, parameters);
