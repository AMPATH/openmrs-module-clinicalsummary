...
/**
 */
public class HospitalReferralReminderRule extends MalnutritionReminderRule {

	private static final Log log = LogFactory.getLog(HospitalReferralReminderRule.class);

	public static final String TOKEN = "Hospital Referral Reminder";
