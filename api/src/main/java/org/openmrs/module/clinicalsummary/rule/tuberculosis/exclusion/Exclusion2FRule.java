 ...
 */
public class Exclusion2FRule extends EvaluableRule {

    public static final String TOKEN = "Tuberculosis:Exclusion 2F";
    ...
    protected Result evaluate(final LogicContext context, final Integer patientId, final Map<String, Object> parameters) {
        ...
        parameters.put(EvaluableConstants.OBS_CONCEPT, Arrays.asList(ANTI_TB_ADHERENCE));
