...
//            result.add(new Result("Reminder 10 excluded by Ex1A"));
//            return result;
//        }
//
...
//            result.add(new Result("Reminder 10 excluded by Ex1B"));
//            return result;
//        }
//
        ...
        if (exclusion1CResult.toBoolean()) {
            result.add(new Result("Reminder 10 excluded by Ex1C"));
            return result;
        }
//
...
//            result.add(new Result("Reminder 10 excluded by Ex1D"));
//            return result;
//        }
        ...
        if (exclusion2AResult.toBoolean()) {
            result.add(new Result("Reminder 10 excluded by Ex2A"));
            return result;
        }
        ...
        if (exclusion2BResult.toBoolean()) {
            result.add(new Result("Reminder 10 excluded by Ex2B"));
            return result;
        }
        ...
        if (exclusion2CResult.toBoolean()) {
            result.add(new Result("Reminder 10 excluded by Ex2C"));
            return result;
        }
        ...
        if (exclusion2DResult.toBoolean()) {
            result.add(new Result("Reminder 10 excluded by Ex2D"));
            return result;
        }
        ...
        if (exclusion2FResult.toBoolean()) {
            result.add(new Result("Reminder 10 excluded by Ex2F"));
            return result;
        }
        ...
        if (exclusion2EResult.toBoolean()) {
            result.add(new Result("Reminder 10 excluded by Ex2E"));
            return result;
        }
        ...
        if (exclusion2GResult.toBoolean()) {
            result.add(new Result("Reminder 10 excluded by Ex2G"));
            return result;
        }
        ...
        if (exclusion3AResult.toBoolean()) {
            result.add(new Result("Reminder 10 excluded by Ex3A"));
            return result;
        }
        ...
        if (exclusion3BResult.toBoolean()) {
            result.add(new Result("Reminder 10 excluded by Ex3B"));
            return result;
        }
        ...
        if (exclusion3DResult.toBoolean()) {
            result.add(new Result("Reminder 10 excluded by Ex3D"));
            return result;
        }
        ...
        if (exclusion4AResult.toBoolean()) {
            result.add(new Result("Reminder 10 excluded by Ex4A"));
            return result;
        }
        ...
        if (exclusion4BResult.toBoolean()) {
            result.add(new Result("Reminder 10 excluded by Ex4B"));
            return result;
        }
        ...
        if (exclusion4CResult.toBoolean()) {
            result.add(new Result("Reminder 10 excluded by Ex4C"));
            return result;
        }
        ...
        if (exclusion4DResult.toBoolean()) {
            result.add(new Result("Reminder 10 excluded by Ex4D"));
            return result;
        }
        ...
        if (element10AResult.toBoolean()) {
            result.add(new Result("Reminder 10 excluded by E10A"));
            return result;
        }
        ...
        if (element10BResult.toBoolean()) {
            result.add(new Result("Reminder 10 excluded by E10B"));
            return result;
        }
        ...
        if (element10CResult.toBoolean()) {
            result.add(new Result("Reminder 10 excluded by E10C"));
            return result;
        }
        ...
        if (element10DResult.toBoolean()) {
            result.add(new Result("Reminder 10 excluded by E10D"));
            return result;
        }
        ...
        if (element10EResult.toBoolean()) {
            result.add(new Result("Reminder 10 excluded by E10E"));
            return result;
        }

        Element10FRule element10FRule = new Element10FRule();
        Result element10FResult = element10FRule.eval(context, patientId, new HashMap<String, Object>());
        if (element10FResult.toBoolean()) {
            result.add(new Result("Reminder 10 excluded by E10F"));
            return result;
        }
