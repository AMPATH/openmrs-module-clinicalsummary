...
public class AdultCreatinineReminderRule extends EvaluableRule {

	private static final Log log = LogFactory.getLog(AdultCreatinineReminderRule.class);

	public static final String TOKEN = "Adult Creatinine Reminder";
