 ...
 */
public class InhScreeningTestReminderRule extends EvaluableRule {

    public static final String TOKEN = "Tuberculosis:INH Screening Test Reminder";
    ...
    protected Result evaluate(final LogicContext context, final Integer patientId, final Map<String, Object> parameters) {
        ...
        CxrResultExistsRule cxrResultExistsRule = new CxrResultExistsRule();
        Result cxrExistsResult = cxrResultExistsRule.eval(context, patientId, parameters);
        if (cxrExistsResult.toBoolean()) {
            return result;
        }
