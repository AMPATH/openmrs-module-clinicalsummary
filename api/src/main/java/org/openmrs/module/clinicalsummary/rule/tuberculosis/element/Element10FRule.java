 ...
 */
public class Element10FRule extends EvaluableRule {

    public static final String TOKEN = "Tuberculosis:Element 10F";
    ...
    protected Result evaluate(final LogicContext context, final Integer patientId, final Map<String, Object> parameters) {
        ...
        parameters.put(EvaluableConstants.OBS_VALUE_CODED, Arrays.asList(TUBERCULOSIS_TREATMENT_OR_DOT_PROGRAM));
