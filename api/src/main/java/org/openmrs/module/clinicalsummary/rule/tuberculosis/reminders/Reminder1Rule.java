...
import org.openmrs.module.clinicalsummary.rule.tuberculosis.element.Element1ARule;
import org.openmrs.module.clinicalsummary.rule.tuberculosis.element.Element1BRule;
import org.openmrs.module.clinicalsummary.rule.tuberculosis.element.Element1CRule;
 ...
 */
public class Reminder1Rule extends EvaluableRule {
...
//            result.add(new Result("Reminder 1 excluded by Ex1A"));
//            return result;
//        }
//
...
//            result.add(new Result("Reminder 1 excluded by Ex1B"));
//            return result;
//        }
//
        ...
        if (exclusion1CResult.toBoolean()) {
            result.add(new Result("Reminder 1 excluded by Ex1C"));
            return result;
        }
//
...
//            result.add(new Result("Reminder 1 excluded by Ex1D"));
//            return result;
//        }
        ...
        if (exclusion2AResult.toBoolean()) {
            result.add(new Result("Reminder 1 excluded by Ex2A"));
            return result;
        }
        ...
        if (exclusion2BResult.toBoolean()) {
            result.add(new Result("Reminder 1 excluded by Ex2B"));
            return result;
        }
        ...
        if (exclusion2CResult.toBoolean()) {
            result.add(new Result("Reminder 1 excluded by Ex2C"));
            return result;
        }
        ...
        if (exclusion2DResult.toBoolean()) {
            result.add(new Result("Reminder 1 excluded by Ex2D"));
            return result;
        }
        ...
        if (exclusion2FResult.toBoolean()) {
            result.add(new Result("Reminder 1 excluded by Ex2F"));
            return result;
        }
        ...
        if (exclusion2EResult.toBoolean()) {
            result.add(new Result("Reminder 1 excluded by Ex2E"));
            return result;
        }
        ...
        if (exclusion2GResult.toBoolean()) {
            result.add(new Result("Reminder 1 excluded by Ex2G"));
            return result;
        }
        ...
        if (exclusion3AResult.toBoolean()) {
            result.add(new Result("Reminder 1 excluded by Ex3A"));
            return result;
        }
        ...
        if (exclusion3BResult.toBoolean()) {
            result.add(new Result("Reminder 1 excluded by Ex3B"));
            return result;
        }
        ...
        if (exclusion3DResult.toBoolean()) {
            result.add(new Result("Reminder 1 excluded by Ex3D"));
            return result;
        }
        ...
        if (exclusion4AResult.toBoolean()) {
            result.add(new Result("Reminder 1 excluded by Ex4A"));
            return result;
        }
        ...
        if (exclusion4BResult.toBoolean()) {
            result.add(new Result("Reminder 1 excluded by Ex4B"));
            return result;
        }
        ...
        if (exclusion4CResult.toBoolean()) {
            result.add(new Result("Reminder 1 excluded by Ex4C"));
            return result;
        }
        ...
        if (exclusion4DResult.toBoolean()) {
            result.add(new Result("Reminder 1 excluded by Ex4D"));
            return result;
        }

        Element1ARule element1ARule = new Element1ARule();
        Result element1AResult = element1ARule.eval(context, patientId, new HashMap<String, Object>());
        if (element1AResult.toBoolean()) {
            result.add(new Result("Reminder 1 excluded by E1A"));
            return result;
        }

        Element1BRule element1BRule = new Element1BRule();
        Result element1BResult = element1BRule.eval(context, patientId, new HashMap<String, Object>());
        if (element1BResult.toBoolean()) {
            result.add(new Result("Reminder 1 excluded by E1B"));
            return result;
        }

        Element1CRule element1CRule = new Element1CRule();
        Result element1CResult = element1CRule.eval(context, patientId, new HashMap<String, Object>());
        if (element1CResult.toBoolean()) {
            result.add(new Result("Reminder 1 excluded by E1C"));
            return result;
        }
