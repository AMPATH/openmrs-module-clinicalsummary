 ...
 */
public class ObsFlowsheetRule extends EvaluableRule {

	private static final Log log = LogFactory.getLog(ObsFlowsheetRule.class);

	public static final String TOKEN = "Obs Flowsheet";
	...
	protected Result evaluate(final LogicContext context, final Integer patientId, final Map<String, Object> parameters) throws LogicException {
		...
		Result validResults = FlowsheetUtils.slice(results);
		Collections.reverse(validResults);
		return validResults;
	}
