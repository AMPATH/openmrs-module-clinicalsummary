...
package org.openmrs.module.clinicalsummary.rule.treatment;
 ...
 */
public class TuberculosisTreatmentRule extends EvaluableRule {

	private static final Log log = LogFactory.getLog(TuberculosisTreatmentRule.class);

	public static final String TOKEN = "Tuberculosis Treatment";
