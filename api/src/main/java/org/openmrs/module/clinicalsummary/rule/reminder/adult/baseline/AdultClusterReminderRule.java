...
public class AdultClusterReminderRule extends EvaluableRule {

	private static final Log log = LogFactory.getLog(AdultClusterReminderRule.class);

	public static final String TOKEN = "Adult Cluster Reminder";
