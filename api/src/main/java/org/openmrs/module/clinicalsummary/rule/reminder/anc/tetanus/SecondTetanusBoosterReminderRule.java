...
public class SecondTetanusBoosterReminderRule extends AbstractTetanusBoosterReminderRule {

	private static final Log log = LogFactory.getLog(SecondTetanusBoosterReminderRule.class);

	private static final String TOKEN = AbstractTetanusBoosterReminderRule.SECOND_TETANUS_BOOSTER_REMINDER;
