...
public class Reminder9Rule extends EvaluableRule {
    ...
    public static final String TOKEN = "Tuberculosis: Reminder 9";
...
//            result.add(new Result("Reminder 9 excluded by Ex1A"));
//            return result;
//        }
//
...
//            result.add(new Result("Reminder 9 excluded by Ex1B"));
//            return result;
//        }
//
        ...
        if (exclusion1CResult.toBoolean()) {
            result.add(new Result("Reminder 9 excluded by Ex1C"));
            return result;
        }
//
...
//            result.add(new Result("Reminder 9 excluded by Ex1D"));
//            return result;
//        }
        ...
        if (exclusion2AResult.toBoolean()) {
            result.add(new Result("Reminder 9 excluded by Ex2A"));
            return result;
        }
        ...
        if (exclusion2BResult.toBoolean()) {
            result.add(new Result("Reminder 9 excluded by Ex2B"));
            return result;
        }
        ...
        if (exclusion2CResult.toBoolean()) {
            result.add(new Result("Reminder 9 excluded by Ex2C"));
            return result;
        }
        ...
        if (exclusion2DResult.toBoolean()) {
            result.add(new Result("Reminder 9 excluded by Ex2D"));
            return result;
        }
        ...
        if (exclusion2FResult.toBoolean()) {
            result.add(new Result("Reminder 9 excluded by Ex2F"));
            return result;
        }
        ...
        if (exclusion2EResult.toBoolean()) {
            result.add(new Result("Reminder 9 excluded by Ex2E"));
            return result;
        }
        ...
        if (exclusion2GResult.toBoolean()) {
            result.add(new Result("Reminder 9 excluded by Ex2G"));
            return result;
        }
        ...
        if (exclusion3AResult.toBoolean()) {
            result.add(new Result("Reminder 9 excluded by Ex3A"));
            return result;
        }
        ...
        if (exclusion3BResult.toBoolean()) {
            result.add(new Result("Reminder 9 excluded by Ex3B"));
            return result;
        }
        ...
        if (exclusion3DResult.toBoolean()) {
            result.add(new Result("Reminder 9 excluded by Ex3D"));
            return result;
        }
        ...
        if (exclusion4AResult.toBoolean()) {
            result.add(new Result("Reminder 9 excluded by Ex4A"));
            return result;
        }
        ...
        if (exclusion4BResult.toBoolean()) {
            result.add(new Result("Reminder 9 excluded by Ex4B"));
            return result;
        }
        ...
        if (exclusion4CResult.toBoolean()) {
            result.add(new Result("Reminder 9 excluded by Ex4C"));
            return result;
        }
        ...
        if (exclusion4DResult.toBoolean()) {
            result.add(new Result("Reminder 9 excluded by Ex4D"));
            return result;
        }

        Element9ARule element9ARule = new Element9ARule();
        Result element9AResult = element9ARule.eval(context, patientId, new HashMap<String, Object>());
        if (element9AResult.toBoolean()) {
            result.add(new Result("Reminder 9 excluded by E9A"));
            return result;
        }

        Element9BRule element9BRule = new Element9BRule();
        Result element9BResult = element9BRule.eval(context, patientId, new HashMap<String, Object>());
        if (element9BResult.toBoolean()) {
            result.add(new Result("Reminder 9 excluded by E9B"));
            return result;
        }

        Element9CRule element9CRule = new Element9CRule();
        Result element9CResult = element9CRule.eval(context, patientId, new HashMap<String, Object>());
        if (element9CResult.toBoolean()) {
            result.add(new Result("Reminder 9 excluded by E9C"));
            return result;
        }
