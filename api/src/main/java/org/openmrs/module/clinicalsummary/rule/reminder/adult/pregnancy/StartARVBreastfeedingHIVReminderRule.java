...
public class StartARVBreastfeedingHIVReminderRule extends EvaluableRule {
    ...
    public static final String TOKEN = "Adult:Start ARV Breastfeeding HIV Positive";
        ...
        if (CollectionUtils.isNotEmpty(encounterResults)) {
            ...
            if (CollectionUtils.isEmpty(arvResults)) {
                ...
                if (CollectionUtils.isNotEmpty(currentlyBreastfeedingResults)) {
                    Result urinePregnancyResult = currentlyBreastfeedingResults.latest();
                ...
                if (CollectionUtils.isNotEmpty(feedingMethodResults)) {
                    Result problemAddedResult = feedingMethodResults.latest();
