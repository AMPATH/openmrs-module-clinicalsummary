...
public class PediatricCXRReminderRule extends EvaluableRule {

	private static final Log log = LogFactory.getLog(PediatricCXRReminderRule.class);

	public static final String TOKEN = "Pediatric CXR Reminder";
