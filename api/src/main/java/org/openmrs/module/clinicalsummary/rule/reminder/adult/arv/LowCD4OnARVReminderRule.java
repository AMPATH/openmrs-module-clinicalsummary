...
public class LowCD4OnARVReminderRule extends EvaluableRule {

	private static final Log log = LogFactory.getLog(LowCD4OnARVReminderRule.class);

	public static final String TOKEN = "Low CD4 On Anti Retro Viral Reminder";
	...
	protected Result evaluate(final LogicContext context, final Integer patientId, final Map<String, Object> parameters) throws LogicException {
		...
		if (CollectionUtils.isNotEmpty(clusterResults)) {
			...
			if (CollectionUtils.isNotEmpty(planResults)) {
				...
				if (planResult.getResultDate().after(oneYearAgo)
						|| planResult.getResultDate().after(oneYearBeforeResult)
						|| clusterResult.toNumber() > 100
