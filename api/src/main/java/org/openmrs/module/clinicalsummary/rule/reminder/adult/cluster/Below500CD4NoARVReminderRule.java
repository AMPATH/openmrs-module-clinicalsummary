...
public class Below500CD4NoARVReminderRule extends EvaluableRule {

	private static final Log log = LogFactory.getLog(Below500CD4NoARVReminderRule.class);

	public static final String TOKEN = "Below 500 CD4 No Anti Retro Viral Reminder";
