...
public class PediatricClusterReminderRule extends EvaluableRule {

	private static final Log log = LogFactory.getLog(PediatricClusterReminderRule.class);

	public static final String TOKEN = "Pediatric Cluster Reminder";
