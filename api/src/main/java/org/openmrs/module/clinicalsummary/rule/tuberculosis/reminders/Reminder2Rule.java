...
//        }
        ...
        if (exclusion2GResult.toBoolean()) {
            result.add(new Result("Reminder 2 excluded by Ex2G"));
            return result;
        }
        ...
        Result element2AResult = element2ARule.eval(context, patientId, new HashMap<String, Object>());
        ...
        Result element2BResult = element2BRule.eval(context, patientId, new HashMap<String, Object>());
