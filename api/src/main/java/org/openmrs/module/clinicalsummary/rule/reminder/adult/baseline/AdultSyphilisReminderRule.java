...
public class AdultSyphilisReminderRule extends EvaluableRule {

	private static final Log log = LogFactory.getLog(AdultSyphilisReminderRule.class);

	public static final String TOKEN = "Adult Syphilis Reminder";
