 ...
 */
public class Exclusion4DRule extends EvaluableRule {

    public static final String TOKEN = "Tuberculosis:Exclusion 4D";
    ...
    protected Result evaluate(final LogicContext context, final Integer patientId, final Map<String, Object> parameters) {
        ...
        parameters.put(EvaluableConstants.OBS_VALUE_CODED,
                Arrays.asList(WEIGHT_CHANGE, TUBERCULOSIS, COMPLETED, TOXICITY_DRUG, OTHER_NON_CODED,
