...
public class Below400CD4OnARVReminderRule extends EvaluableRule {

	private static final Log log = LogFactory.getLog(Below400CD4OnARVReminderRule.class);

	public static final String TOKEN = "Below 400 CD4 On Anti Retro Viral Reminder";
	...
	protected Result evaluate(final LogicContext context, final Integer patientId, final Map<String, Object> parameters) throws LogicException {
		...
		if (CollectionUtils.isNotEmpty(obsClusterResults)) {
			...
			if (latestClusterResult.toNumber() < 400 && latestClusterResult.getResultDate().before(calendar.getTime())) {
				...
				if (CollectionUtils.isEmpty(testResults) || testResults.getResultDate().before(calendar.getTime())) {
