...
public class AdultHemoglobinReminderRule extends EvaluableRule {

	private static final Log log = LogFactory.getLog(AdultHemoglobinReminderRule.class);

	public static final String TOKEN = "Adult Hemoglobin Reminder";
	...
	protected Result evaluate(final LogicContext context, final Integer patientId, final Map<String, Object> parameters) throws LogicException {
		...
		parameters.put(EvaluableConstants.OBS_VALUE_CODED, Arrays.asList(EvaluableNameConstants.HEMOGLOBIN, EvaluableNameConstants.COMPLETE_BLOOD_COUNT));
